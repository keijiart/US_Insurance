...
class PatientsInfo:
    ...
    def analyze_ages(self):
        ...
        return print("Average Patient Age: " + str(round(total_age / len(self.patients_ages), 2)) + " years")
...
# The next step is to create an instance of the class called `patient_info`.
